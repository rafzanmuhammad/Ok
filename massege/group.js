...
aqua.sendMessage(from, { caption: intro, image: `${welccom}`, buttons: butIn, footer: 'tes welcome' })
...
aqua.sendMessage(from, { caption: outro, image: `${welccom}`, buttons: butOut, footer: 'tes welcome' })
