    ...
    return new Promise(async (resolve, reject) => {
        axios.request({
            ...
            .then(({ data }) => {
                ...
                axios.post('https://www.instagramsave.com/system/action.php')
                    .then(({ data }) => {
                        resolve(data.medias)
                    })
            })
...
module.exports = {igstory, igdl, pinterest, wallpaper, wikimedia, quotesAnime, aiovideodl, umma, ringtone, styletext }
